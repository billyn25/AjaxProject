...
function Resumen({datos, reset}) {
    ...
    let pdfExport = () => {
        ...
        var opt = {
            ...
            html2canvas: {y:0,scrollX: 0, scrollY: 0, dpi: 192, letterRendering: true, useCORS: true},
                    ...
                    <div className="table-responsive-sm" id='divTable'>
                        <form id="form" className="pt-4 pb-4 row g-3 justify-content-between align-items-center">
                            <div className="ml-3 mr-4">
                                ...
                                <p className="text-dark bg-white text-center mt-2 mb-0 pb-0">{f.getDate() + "-"+ (new Date().getMonth()+1)+ "-" +f.getFullYear()}</p>
                            </div>
                        ...
                        <table id="table-to-xls" className="table mb-5">
                            <thead>
                            <tr className="verdeAj border-top">
                            ...
                            {Object.keys(data).length >= 1 && (<tbody>
                                ...
                                <tr className="bg-white">
                                    ...
                                    <td colSpan="2" className="text-right">
                                        ...
                                        <p className="float-right">iva incl. {(sumPvp(data) * 1.21).toFixed(2)} €</p>
                                    </td>
